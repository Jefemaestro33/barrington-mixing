...
\title{Spectral Contraction and T-Independence in Barrington Branching Programs:\\
Resolving the Uniform Mixing Conjecture for Point Functions over $S_5$}
...
\midrule
$(4,1)$     & 4 & 3 & $3.53 \times 10^{-2}$ & Level $3$ \\
...
\midrule
$8$   & $3$ & $3.53 \times 10^{-2}$ & $2.12 \times 10^{-1}$ \\
$16$  & $4$ & $1.55 \times 10^{-6}$ & $9.33 \times 10^{-6}$ \\
$32$  & $5$ & $5.83 \times 10^{-24}$ & $3.50 \times 10^{-23}$ \\
$64$  & $6$ & $1.15 \times 10^{-93}$ & $6.90 \times 10^{-93}$ \\
\bottomrule
\end{tabular}
\end{center}
...
The full verification suite consists of $13$ scripts,
...
\bibitem{BKMPRS18}
A.~Bishop, A.~Kowalczyk, T.~Malkin, L.~Pastro, M.~Raykova, and K.~Shi.
